...
{
  "mcpServers": {
    "agentskit": { "command": "npx", "args": ["-y", "@agentskit/mcp@0.4.4", "--tools", "fetch,search"] }
  }
}
```
...
command = "npx"
args = ["-y", "@agentskit/mcp@0.4.4", "--tools", "fetch,search"]
```
...
```bash
npx @agentskit/mcp@0.4.4 --agents legal-contract-reviewer,fintech-kyc-screener --provider openai
```
