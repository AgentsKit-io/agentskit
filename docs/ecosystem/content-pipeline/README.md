...
- `coding-agent-mcp` — credential-free local and published MCP proofs plus host-specific
  configuration for Codex, Claude Code/Desktop, Cursor, Cline, and Continue.
