...
Why it exists: Agent applications should be able to change model providers without moving provider-specific logic into the task, runtime, tools, or result handling.
...
3. `AGENT_PROVIDER=local npx tsx agent.ts`
