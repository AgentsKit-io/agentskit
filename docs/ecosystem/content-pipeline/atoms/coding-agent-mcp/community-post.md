...
```bash
codex mcp add agentskit -- npx -y @agentskit/mcp@0.4.2 --tools fetch,search
claude mcp add --scope project --transport stdio agentskit -- npx -y @agentskit/mcp@0.4.2 --tools fetch,search
