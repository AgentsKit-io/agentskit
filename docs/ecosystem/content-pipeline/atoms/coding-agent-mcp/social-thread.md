...
2/ The path:
1. `codex mcp add agentskit -- npx -y @agentskit/mcp@0.4.3 --tools fetch,search`
2. `claude mcp add --scope project --transport stdio agentskit -- npx -y @agentskit/mcp@0.4.3 --tools fetch,search`
