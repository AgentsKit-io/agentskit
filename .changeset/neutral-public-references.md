...
'@agentskit/validation': patch
'@agentskit/vue': patch
---

Republish package READMEs and source comments without references to a discontinued internal product. `@agentskit/sandbox` `processSandbox` now passes through `AGENTSKIT_`-prefixed env keys instead of the old product-specific prefix.
