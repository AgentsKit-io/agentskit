...
export const PACKED_CONSUMER_EXCEPTIONS = Object.freeze([
  ...
  },
  {
    ...
    subpath: './braintrust',
    optionalPeer: true,
    reason: 'Optional peer `braintrust`; imports are checked without invoking the remote SDK.',
  },
  {
    ...
    optionalPeer: true,
    reason: 'Optional peer `braintrust` (scorers subpath); scorer imports are provider-free.',
  },
  {
    ...
    optionalPeer: true,
    reason: 'Optional peer `braintrust` (CI subpath); regression helpers are provider-free.',
  },
])
