...
Every package under `@agentskit/*` is an implementation of one contract. `@agentskit/core` holds the contracts — measured ~5.17 KB gzipped at v1 (budget ≤10 KB), zero dependencies, frozen at the minor level.
