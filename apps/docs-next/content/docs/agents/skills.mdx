---
title: Skills
description: "@agentskit/skills provides five built-in **SkillDefinition** values (system prompts + metadata). Skills carry **tools** hints and **delegates** hints so the runtime knows which tools to merge and whic"
---
