---
title: Tools
description: "@agentskit/tools provides ready-made **ToolDefinition** values for web search, filesystem access, and shell execution. Pass them to [createRuntime](./runtime) or [useChat](../hooks/use-chat)."
---
