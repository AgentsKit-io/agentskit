...
Browse the [canonical integration catalog](https://www.agentskit.io/integrations) for all 50 service descriptors, or read the [integration package contract](/docs/for-agents/integrations) before implementing a connector. Dedicated service guides are linked from the catalog where available.
