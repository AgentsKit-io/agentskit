---
title: "@agentskit/ink"
description: "Terminal chat UI built with [Ink](https://github.com/vadimdemedes/ink). Uses the same [@agentskit/core](../packages/core) controller as @agentskit/react, so the chat logic is identical — only the rend"
---
