---
title: Theming
description: "@agentskit/react ships a default theme as a CSS file. Every element uses data-ak-* attributes as selectors and CSS custom properties as design tokens — no class names, no specificity battles."
---
