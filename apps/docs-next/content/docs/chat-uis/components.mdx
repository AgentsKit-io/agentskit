...
description: "All headless components across @agentskit/react and @agentskit/ink. Components emit data-ak-* attributes (React) or use Ink terminal primitives (Ink) — they carry no opinion about visual styling."
---
