...
- Need the same agent across chat surfaces? Use [AgentsKit Chat](https://github.com/AgentsKit-io/agentskit-chat/tree/main/docs).
- Need repeatable engineering standards? Follow the [Agents Playbook](https://playbook.agentskit.io/docs).
- Need agent-readable repository handoffs? Add [Doc Bridge](https://github.com/AgentsKit-io/doc-bridge/tree/master/docs).
