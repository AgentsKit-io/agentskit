...
- **New tools** — anything in [`@agentskit/tools`](/docs/reference/packages) that doesn't exist yet
...
**[Public roadmap →](https://github.com/orgs/AgentsKit-io/projects/1)** · **[Contributing guide →](/docs/contributing)**
