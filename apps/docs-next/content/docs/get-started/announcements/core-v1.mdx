...
description: "The JavaScript agent foundation library that doesn't lock you in. Measured ~5.17 KB gzipped at v1 (budget ≤10 KB). Zero dependencies. Six contracts pinned to ADRs."
---

# The JavaScript agent foundation library hit 1.0

**~5.17 KB gzipped at the v1 ship (within the ≤10 KB gzip Manifesto budget). Zero dependencies. Six contracts pinned to ADRs.**
...
| | |
|---|---|
| **Core bundle** | ~5.17 KB gzipped at v1 ship — **within** the ≤10 KB Manifesto budget (stats ledger still reports the 10 KB budget floor) |
| **Runtime deps** | Zero |
...
AgentsKit.js is a family of **small, independently installable packages** built on one core under the **10 KB gzip budget**. Every package is plug-and-play. Every contract is open. Every combination composes.
...
That's it. Both helpers were Node-only and crashed browser consumers. Moving them to the packages that already carry Node dependencies restored universal core compatibility. Full guide: [Migrating from 0.4 to 1.0](/docs/get-started/migrating).
...
1. ✅ Core under 10 KB gzipped, zero deps — **~5.17 KB at v1 ship, zero deps**
...
6. ✅ Docs are product — **74 Fumadocs routes, 7 ADRs, 13 recipes, 3 migration guides** {/* count-drift-ignore: historical v1 launch snapshot */}
...
- **New tools** — anything in [`@agentskit/tools`](/docs/reference/packages/tools) that doesn't exist yet
...
**[Public roadmap →](https://github.com/orgs/AgentsKit-io/projects/1)** · **[Contributing guide →](/docs/reference/contribute)**
...
A working chat in under 10 lines: **[Quick start →](/docs/get-started/getting-started/quickstart)**

The mental model behind every package: **[Concepts →](/docs/get-started/concepts/mental-model)**
