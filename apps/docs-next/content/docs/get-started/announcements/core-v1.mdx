...
AgentsKit is a family of **small, independently installable packages** built on one core under the **10 KB gzip budget**. Every package is plug-and-play. Every contract is open. Every combination composes.
