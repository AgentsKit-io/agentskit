...
| `Memory` class with working memory + semantic recall | `ChatMemory` + `VectorMemory` + `Retriever` | Split into three narrow contracts per [ADR 0003](https://github.com/EmersonBraun/agentskit/blob/main/docs/architecture/adrs/0003-memory-contract.md) and [ADR 0004](https://github.com/EmersonBraun/agentskit/blob/main/docs/architecture/adrs/0004-retriever-contract.md) |
