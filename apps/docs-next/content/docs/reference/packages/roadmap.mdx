...
| [`@agentskit/rag`](./rag) | 0.5.x | **beta** | Retriever v1 + RAG composition | Publish the current hardening minor; validate replacement semantics, remote limits, packed consumers, and the beta-to-stable evidence gates |
...
| [`@agentskit/eval`](./eval) | 0.6.x | **beta** | evolving | Harden replay, snapshots, CI reporting, and optional Braintrust upload; publish 1.0 |
...
| [`@agentskit/vue`](./vue) | 0.5.x | **beta** | evolving | Keep the shared state/action contract aligned; Vue 3 SSR tests; binding-specific component docs |
| [`@agentskit/svelte`](./svelte) | 0.5.x | **beta** | evolving | Keep the Svelte 5 store/component contract aligned; SvelteKit SSR/hydration matrix |
| [`@agentskit/solid`](./solid) | 0.5.x | **beta** | evolving | Keep the Solid client/SSR entry boundaries aligned; binding-specific component docs |
| [`@agentskit/react-native`](./react-native) | 0.5.x | **beta** | evolving | Keep Metro/Hermes compatibility; Expo template; Android+iOS test matrix |
| [`@agentskit/angular`](./angular) | 0.5.x | **beta** | evolving | Keep standalone-component/APF contract aligned; Angular minimum/current matrix |
