...
| [`@agentskit/eval`](./eval) | 0.6.x | **beta** | evolving | Keep the suite/replay/CI contracts aligned; publish the public `/braintrust` subpath; continue packed-consumer coverage |
