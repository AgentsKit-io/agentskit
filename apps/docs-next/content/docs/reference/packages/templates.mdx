...
If you want project starters instead of authoring primitives, see [`agentskit init`](/docs/production/cli/init). `@agentskit/templates` is the lower-level toolkit behind that bootstrap path.
