...
const d = groq({ apiKey: process.env.GROQ_API_KEY!, model: 'openai/gpt-oss-120b' })
...
- [Adapter router](/docs/reference/recipes/adapter-router) — auto-pick among them
- [Fallback chain](/docs/reference/recipes/fallback-chain) — graceful degradation
- [Speculative execution](/docs/reference/recipes/speculative-execution) — race across providers
