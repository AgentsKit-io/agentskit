...
[deterministic replay](/docs/reference/recipes/deterministic-replay). Now you
...
```ts
import { replayAgainst, summarizeReplay } from '@agentskit/eval/replay'
...
Pair with [Prompt diff](/docs/reference/recipes/prompt-diff) or the
[Eval suite](/docs/reference/recipes/eval-suite) for richer comparison metrics.
