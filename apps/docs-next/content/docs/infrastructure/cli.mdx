---
title: CLI
description: "@agentskit/cli provides terminal commands for **interactive chat** (Ink), **one-shot agent runs** (headless runtime), and **starter projects**. It reads optional project config from **.agentskit.confi"
---
