---
title: Observability
description: "@agentskit/observability provides **pluggable Observer** implementations for [@agentskit/core](../packages/core) AgentEvent streams. Observers are lazy-friendly: import only the backends you wire into"
---
