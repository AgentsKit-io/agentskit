...
- `@agentskit/observability-langfuse` — Langfuse logger backend. Install `@agentskit/observability-langfuse` and the optional `langfuse` SDK when using this package.
