...
surface proposed in [RFC 0009](../../../../../rfcs/0009-skills-stable.md), but promotion still requires the release history and soak evidence mandated by ADR 0024.
