...
- `readResponseText` / `readResponseBytes` — bounded response readers for text and binary payloads; set `maxResponseBytes` at the integration boundary.
...
- `readResponseText` — read a bounded response body as text for integration adapters.
