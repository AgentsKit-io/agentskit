...
`npx @agentskit/cli add <id>` downloads the manifest at `/r/<id>.json`, verifies the files listed by
...
- [`/deterministic/site-config.json`](/deterministic/site-config.json) — trusted local-answer configuration.
- [`/deterministic/knowledge.json`](/deterministic/knowledge.json) — verified exact-fact artifact.
