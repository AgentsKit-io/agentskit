...
const STEPS = [
  ...
  { n: 2, t: 'Wire it', d: 'It is plain TypeScript in your project. Import the factory and pass any adapter — OpenAI, Anthropic, or any of 184+ catalog providers. Swap the model whenever you want.', code: WIRE },
